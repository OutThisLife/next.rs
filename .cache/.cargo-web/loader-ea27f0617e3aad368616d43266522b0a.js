...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    function __instantiate( instance ) {
        ...
        Module.exports.hash = function hash() {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.hash());
}
;
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'nextrs_client'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'nextrs_client':", error );
                throw error;
            });
    } else {
